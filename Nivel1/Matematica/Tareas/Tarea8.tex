        ...
        \begin{itemize}
            ...
            \begin{enumerate}
                ...
                \item Para que se organice un evento exitoso en un parque, se deben cumplir varias condiciones: debe ser un día soleado, los permisos del gobierno deben estar aprobados, el equipo de sonido debe estar disponible y el catering debe estar confirmado. Además, si llueve, el evento se trasladará a un auditorio, pero solo si el auditorio está disponible.
                    ...
                    \begin{figure}[!h]
                        \centering
                        \includegraphics[width=0.6\textwidth]{Img/Tarea8_b_ej1.png}
                ...
                \item Para que un proyecto de investigación sea aceptado, debe cumplir con ciertos criterios: el proyecto debe ser innovador, debe contar con la aprobación del comité de ética, y debe tener financiamiento asegurado. Además, si el proyecto involucra experimentación con humanos, debe tener la autorización de los sujetos participantes y el respaldo de un hospital.
                    \par$p:$ El proyecto de investigación es aceptado.
                    \par$q:$ El proyecto es innovador.
                    \par$r:$ El proyecto cuenta con la aprobación del comité de ética.
                    \par$s:$ El proyecto tiene financiamiento asegurado.
                    \par$t:$ El proyecto involucra experimentación con humanos.
                    \par$u:$ El proyecto tiene la aprobación de los participantes.
                    \par$v:$ El proyecto tiene el respaldo de un hospital.
                    \par$n = 7$, $2^n = 2^7 = 128.$ \vspace{0.5cm}
                    \par\textbf{Proposición: }$p \leftrightarrow [q \wedge r \wedge s \wedge (t \longrightarrow (u \wedge v))]$\vspace{0.5cm}

                    \begin{figure}[!h]
                        \centering
                        \includegraphics[width=0.6\textwidth]{Img/Tarea8_b_ej2.png}
                    \end{figure} \vspace{0.5cm}\vspace{0.5cm}
                    \par\textbf{Respuesta: } la proposición es una contingencia. \vspace{0.5cm}
                ...
                \item Para ser admitido en un programa de posgrado, un estudiante debe tener una licenciatura, haber pasado un examen de admisión, y contar con una carta de recomendación de un profesor. Además, si el estudiante no tiene una licenciatura en el campo específico del programa, debe haber completado cursos de nivelación.
                    \par$p:$ El estudiate es admitido en un programa de posgrado.
                    \par$q:$ El estudiante tiene una licenciatura.
                    \par$r:$ El estudiante pasó el examen de admisión.
                    \par$s:$ El estudiante cuenta con una carta de recomendación.
                    \par$t:$ La licenciatura es en el campo específico del programa.
                    \par$u:$ El estudiante ha completado cursos de nivelación.
                    \par$n = 6$, $2^n = 2^6 = 64.$ \vspace{0.5cm}
                    \par\textbf{Proposición: }$p \longrightarrow [q \wedge r \wedge s \wedge (\sim t \longrightarrow u)]$\vspace{0.5cm}
